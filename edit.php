...
if (isset($_POST['submit'])) {
    ...
    $lokasi   = mysqli_real_escape_string($conn, $_POST['lokasi']); // ← INI YANG HILANG
    $deskripsi= mysqli_real_escape_string($conn, $_POST['deskripsi']);
    $is_serial = (int)$_POST['is_serial'];
...
<div class="container content">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kondisi" class="form-control"
                       value="<?= htmlspecialchars($barang['kondisi']); ?>">
            </div>

            <div class="mb-3">
                <label>Lokasi Barang</label>
                <input type="text" name="lokasi" class="form-control"
                       value="<?= htmlspecialchars($barang['lokasi']); ?>" required>
            </div>
    ...
    <select name="is_serial" class="form-control" required>
        <option value="1" <?= $barang['is_serial'] == 1 ? 'selected' : '' ?>>Ya</option>
        <option value="0" <?= $barang['is_serial'] == 0 ? 'selected' : '' ?>>Tidak</option>
    </select>
</div>
